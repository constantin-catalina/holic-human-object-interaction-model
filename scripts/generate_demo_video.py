"""
visualize.py
Script standalone pentru vizualizarea rezultatelor HOLIC.
...
def save_timeline_png(pred_classes, entity_types, label_names, out_path):
    ...
    plt.xlabel("Frame")
    plt.suptitle("HOLIC predictions — timeline", fontsize=12)
    plt.tight_layout()
...
def parse_args():
    parser = argparse.ArgumentParser(description="Vizualizare rezultate HOLIC")
