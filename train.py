"""
train.py
Entry point pentru antrenarea HOLIC.
...
from models.losses import HOLICLoss
...
def parse_args():
    parser = argparse.ArgumentParser(description="Antrenare HOLIC")
    ...
    for batch_idx, batch in enumerate(dataloader):
        ...
        with torch.amp.autocast(
            ...
            losses = criterion(
                ...
                segment_logits_bms=outputs.get("segment_logits_bms"),
                u_soft_bms=outputs.get("u_soft_bms"),
            )
...
def main():
    ...
    wandb_project_cfg = OmegaConf.select(cfg, "logging.wandb_project", default="HOLIC")
    ...
    criterion = HOLICLoss(
        ...
        lambda_tc=cfg.training.get("lambda_tc", 0.0),
